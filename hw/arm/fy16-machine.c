...
static void fy16_board_init(MachineState *machine)
{
    ...
    char *fn_rom1 = qemu_find_file(QEMU_FILE_TYPE_BIOS, "fy16_1.bin");
    char *fn_rom2 = qemu_find_file(QEMU_FILE_TYPE_BIOS, "fy16_2.bin");
    ...
    ssize_t rom1_size = load_image_size(fn_rom1, 0x0, 0x800000);
    ssize_t rom2_size = load_image_size(fn_rom2, 0x0, 0x800000);
